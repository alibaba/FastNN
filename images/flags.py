...
tf.app.flags.DEFINE_string('model_name', 'inception_resnet_v2', 'The name of the architecture to train.')
...
tf.app.flags.DEFINE_string('file_pattern', None, 'file pattern for dataset, eg. cifar10_%s.tfrecord for cifar10')
...
tf.app.flags.DEFINE_bool('use_fp16', True,
...
tf.app.flags.DEFINE_string('hooks', 'StopAtStepHook,ProfilerHook,LoggingTensorHook,CheckpointSaverHook',
...
# PAI-Soar Parameters
tf.app.flags.DEFINE_bool('enable_paisoar', True, 'Whether or not to use pai soar.')
tf.app.flags.DEFINE_string("tensor_fusion_policy", 'default', '')
tf.app.flags.DEFINE_string("communication_policy", 'nccl_fullring', '')
tf.app.flags.DEFINE_integer("tensor_fusion_max_bytes", 8<<20, '')
